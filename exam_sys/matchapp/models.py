...
class MatchReport(CreateUpdateMixin):
    ...
    right_list = models.TextField(max_length=10000, null=True, verbose_name='正确题目', help_text='正确的题目')
    error_list = models.TextField(max_length=10000, null=True, verbose_name='错误的题目', help_text='错误的题目')
